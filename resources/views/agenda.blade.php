                        ...
                        <form id="primal-form">
                            <div class="row">
                                ...
                                <div class="col-xl-2 align-self-center mt-1 text-right">
                                    <button class="btn btn-sm btn-success waves-effect waves-light mr-1">
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" class="btn btn-primary btn-sm float-right"><i
                        ...
                        <div class="col-6">
                            <div class="card-box">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="valor" placeholder="19887" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
